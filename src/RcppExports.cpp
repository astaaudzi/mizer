...
RcppExport SEXP _mizerRewire_inner_project_loop(SEXP no_spSEXP, SEXP no_wSEXP, SEXP nSEXP, SEXP ASEXP, SEXP BSEXP, SEXP SSEXP, SEXP w_min_idxSEXP) {
BEGIN_RCPP
...
static const R_CallMethodDef CallEntries[] = {
    {"_mizerRewire_inner_project_loop", (DL_FUNC) &_mizerRewire_inner_project_loop, 7},
    {NULL, NULL, 0}
};

RcppExport void R_init_mizerRewire(DllInfo *dll) {
